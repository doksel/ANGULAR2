...
var CreateTodoComponent = (function () {
    function CreateTodoComponent() {
        ...
        this.userValueSend = new core_1.EventEmitter();
    }
    CreateTodoComponent.prototype.onCreate = function (newTaskTitle) {
        this.onCreated.emit(newTaskTitle);
        this.newTaskTitle = '';
    };
    CreateTodoComponent.prototype.onValueSend = function (str) {
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], CreateTodoComponent.prototype, "userValue", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], CreateTodoComponent.prototype, "value2", void 0);
    __decorate([
        core_1.Output(), 
    ...
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], CreateTodoComponent.prototype, "userValueSend", void 0);
